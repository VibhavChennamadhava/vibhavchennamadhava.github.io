...
const projectDefinitions: Record<string, Omit<Project, 'stars' | 'forks'>[]> = {
  featured: [
    {
      title: 'CCNA Enterprise Campus Mega Lab',
      subtitle: 'Routing, Switching & Network Security',
      outcome: 'Designed and documented a CCNA-scale enterprise campus network to demonstrate secure segmentation, resilient routing, and operational troubleshooting across realistic infrastructure tiers.',
      whatBuilt: 'Multi-VLAN campus topology with core/distribution/access layers, inter-VLAN routing, trunking, EtherChannel, DHCP, ACL enforcement, NAT, static and dynamic routing, and verification runbooks.',
      techStack: ['Cisco IOS', 'Packet Tracer', 'VLANs', 'OSPF', 'ACLs', 'NAT', 'STP', 'EtherChannel'],
      securityFocus: 'Network segmentation, least-privilege access control, routing resilience, and evidence-based troubleshooting for enterprise infrastructure.',
      iconColor: 'teal',
      links: [
        { label: 'Lab Repo', href: 'https://github.com/VibhavChennamadhava/CCNA-Enterprise-Campus-Mega-Lab' },
      ],
      href: 'https://github.com/VibhavChennamadhava/CCNA-Enterprise-Campus-Mega-Lab',
      githubUrl: 'https://github.com/VibhavChennamadhava/CCNA-Enterprise-Campus-Mega-Lab',
    },
    {
    ...
    },
    {
      ...
      outcome: 'Modeled triage workflows for endpoint telemetry to practice alert validation, evidence collection, and escalation decisions.',
      whatBuilt: 'Agent telemetry collection, rule-based alerting, IOC-driven investigation notes, and analyst-style validation steps.',
      techStack: ['Wazuh', 'SIEM', 'EDR', 'Linux', 'Log Analysis'],
      securityFocus: 'Alert fidelity, endpoint log correlation, and incident response readiness.',
      iconColor: 'blue',
      links: [
        { label: 'Project Repo', href: 'https://github.com/VibhavChennamadhava/SOC_lab' },
      ],
      href: 'https://github.com/VibhavChennamadhava/SOC_lab',
      githubUrl: 'https://github.com/VibhavChennamadhava/SOC_lab',
    },
    {
      title: 'SMTP Mail Server Lab',
      subtitle: 'Email Security',
      outcome: 'Deployed a production-like mail server with authentication and DNS hardening to validate secure delivery and sender reputation.',
